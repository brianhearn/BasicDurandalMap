...
declare module mapsjs {
    ...
    export class geometry {
        constructor(isPath?: boolean, isClosed?: boolean, points?: point[]);
        ...
        /**
		 * Returns the geometry's centroid as a point
		 * @returns {point} The centroid as a point.
		 */
        getCentroid(): point;
    ...
    export module geometry {
        ...
        class polyline extends geometry {
			...
			/**
			 * Calculates distance of a polyline according to projected map cooordinates. 
			 * If no index is provided, calculates the entire distance.
			 * @param {number} [idx] Index of the path for which to compute the distance.
			 * @returns {number} Length in meters.
			 */
            getProjectedDistance(idx?: number): number;
			
			/**
			 * Calculates distance of a polyline according to actual earth surface distance. 
			 * If no index is provided, calculates the entire distance.
       ...
       class polygon extends geometry {
			...
			/**
			 * Gets a ring from this polygon's ring collection by index, or, 
			 * if no index is provided, gets the last ring or null if no rings
            ...
            /**
			 * Gets number of holes in this polygon.
			 * @returns {number} Number of holes.
			 */
            getHoleCount(): number;
		
			/**
			 * Gets a hole from this polygon's hole collection by index, or, 
			 * if no index is provided, gets the last hole or null if no holes
			 * @param {number} [idx] Index of the hole to return.
			 * @returns {number[]} A ring as an array of points in the form [xn,yn].
			 */
            getHole(idx?: number): number[];
			
			
			/**
			 * Calculates area of a polygon by projected map cooordinates. 
			 * If no index is provided, calculates the entire area subtracting holes from the rings.
			...
			/**
			 * Calculates perimeter of a polygon in projected map cooordinates. 
			 * If no index is provided, sums all perimeters.
			...
			/**
			 * Calculates area of a polygon by actual earth surface units
			 * If no index is provided, calculates the entire area subtracting holes from the outer ring.
			 * @param {number} [idx] Index of the ring for which to compute the area.
			 * @returns {number} Area in square meters.
			 */
			...
			/**
			* Calculates perimeter of a polygon in actual earth surface units. 
			* If no index is provided, sums all perimeters.
			 * @param {number} [idx] Index of the ring for which to compute the perimeter.
			 * @returns {number} Length in meters.
			 */
    ...
    export module point {
        ...
        /**
         * Computes the interpolation of two points.
         * @param {number} x1 The x coordinate for the first point.
         * @param {number} y1 The y coordinate for the first point. 
         * @param {number} x2 The x coordinate for the second point. 
         * @param {number} y2 The y coordinate for the second point. 
        * @param {number} weight The weighting from 0 to 1 between the two points. 
         * @return {point} interpolated point.
         */
        export function interpolate(x1: number, y1: number, x2: number, y2: number, weight: number): point;
    }
    ...
    export module tile {
        ...
        export class layer {
             ...
             */			 
            setRequestor(req: requestor, desc?: any): void;
        ...
        export class requestorOpen extends requestor {
            constructor(endpoint: string, subdomains: string[],
                options?: {
                dataFormat?: string;
                timeoutMs?: number;
                maxAvailableZoomLevel?: number;
        ...
        export class requestorLocal extends requestor {
            ...
            /**
            * Returns aggregation of rows.
            * @param {string} op An operation either 'count', 'sum', 'min' or 'max'
            * @param {string} fieldname An optional fieldname to aggregate on - not needed for count
            * @param {function} filter An optional function taking a single row as an associative array {field, val} and a shape and return true if it is to be filtered (omitted)
            * @returns {number} The aggregation.
            */
            aggregate(op: string, fieldname?: string, filter?: (row: any, shape: any) => boolean): number;
        ...
        export class descriptorLocal {
            ...
            getValueFieldNames(): string[];
            setValueFieldNames(vfn: string[]): void;
            getGeometryFieldName(): string;
            setGeometryFieldName(gfn: string): void;
            getBleedRatio(): number;
            setBleedRatio(br: number): void;
        }
    }
    ...
    interface WidgetOptions {
        ...
        pointerClickAction?: (pt: point, ctrlKey?: boolean, shiftKey?: boolean) => void;
    ...
    interface mapsjsWidget {
        ...
        */
		 ...
		 */
        setPointerClickAction(action: (pt: point, ctrlKey?: boolean, shiftKey?: boolean) => void): void;
